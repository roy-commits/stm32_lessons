                                ...
                                uint16_t TIM_ICPolarity, uint16_t ICFilter)
{
  ...
  /* Configure the Timer Input Clock Src */
...
/**
  ...
  *   This parameter can be one of the following values:
  *     @arg TIM_UpdateSource_Global: Src of update is the counter overflow/underflow
                                       or the setting of UG bit, or an update generation
                                       through the slave mode controller.
  *     @arg TIM_UpdateSource_Regular: Src of update is counter overflow/underflow.
  * @retval None
  */
